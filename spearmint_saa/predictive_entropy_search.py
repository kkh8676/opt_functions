...
class PES(AbstractAcquisitionFunction):
    ...
    # 20.10.01
    # modified to use alrady sampled hyperparameters.........
    # added first parameter in create_acquisition_function
    def create_acquisition_function_v2(self, obj_model_dict, con_models_dict,
        first =False,fast=False, grid=None, DEBUG_xstar=None, current_best=None,
        num_random_features=1000,
        x_star_grid_size=1000, x_star_tolerance=1e-6, num_x_star_samples=1):
