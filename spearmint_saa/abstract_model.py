...
def function_over_hypers_specific_num(models, fun, specific_num=1, *fun_args, **fun_kwargs):
    return function_over_hypers_subset(models, fun, specific_num, *fun_args, **fun_kwargs)
...
def function_over_hypers_subset_last(models, fun, subset, *fun_args, **fun_kwargs):
