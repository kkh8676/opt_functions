...
class DefaultChooser(object):
    ...
    # for GP Hedge version!!!!
    # started 20.10.31 
    # should be finished until 11/01
    # Let's go!!
    def suggest_gp_hedge(self, task_couplings):

        ## What this process if for?
        ## What is the task?
        if not isinstance(task_couplings, dict):
            task_couplings = {task_name : 0 for task_name in task_couplings}
        ...
        ## If there is not enough data to suggest......
        ...
        logging.info(self.cumulative_gains)
        ...
        # Returned_cand_list has 4 dictionary
        # that dictionary has key "location", "value", we need "location" for reward and gain
