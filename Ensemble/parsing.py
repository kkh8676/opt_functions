...
def parse_config(options, verbose=False, update_options=None):
    ...
    if options["acquisition"] == "PI":
        options["acquisition"] = "ProbabilityImprovement"

    if options["acquisition"] == "LCB":
        options["acquisition"] = "LowerConfidenceBound" 
    ...
    for task_name, task_opts in options['tasks'].iteritems():
        ...
        if task_opts['acquisition'] == "ExpectedImprovement" or task_opts['acquisition'] == "ProbabilityImprovement":
