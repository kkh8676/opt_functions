...
# sampling one hyperparameter function needs to be coded. : "fit_another" function
# 
...
class GP(AbstractModel):
    ...
    # Sampling "num_samples" number of hyperparameter of the model
    ...
    def predict(self, pred, full_cov=False, compute_grad=False):
        ...
        # Using cached information or compute it....
