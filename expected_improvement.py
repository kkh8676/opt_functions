...
class ExpectedImprovement(AbstractAcquisitionFunction):
    ...
    # 20.07.24
    # added self.stored_acq for analyzing
    # in the compute_ei method ?
    # or lambda? 
    # storing current acquisition values......
    def create_acquisition_function_ver1(self, objective_model_dict, constraint_models_dict, current_best, **kwargs):
        ...
        if len(constraint_models_dict) == 0:
            def acquisition(cand, compute_grad, **kwargs):
                ...
                acq_dict = compute_ei(objective_model, cand, ei_target = current_best, compute_grad = compute_grad)
